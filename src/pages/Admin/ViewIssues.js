        ...
        <Tabs className="tabs">
          ...
          <TabPanel>
            <Container>
              <hr />
              <br />
              <IssueAccordian number="1" id="123456789" department="IT" name="Siddharth Tewani" details="Bahut tang kaar rhe haaa" />
              <IssueAccordian number="2" id="123456789" department="IT" name="solved" details="ohohoho" />
              <IssueAccordian number="3" id="123456789" department="IT" name="solved" details="ohohoho" />
            </Container>
          </TabPanel>
...
export default withRouter(RaiseQuery);